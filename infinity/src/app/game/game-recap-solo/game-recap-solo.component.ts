...
@Component({
  selector: 'app-game-recap-solo',
  templateUrl: './game-recap-solo.component.html',
  styleUrls: ['./game-recap-solo.component.scss'],
})
export class GameRecapSoloComponent implements OnInit {
  leftPlayer!: any;
  rightPlayer!: any;
  ...
  async ngOnInit() {
    ...
    this.scoreLeft = this.gameService.scoreSoloLeft;
    this.scoreRight = this.gameService.scoreSoloRight;
    ...
    this.rightPlayer = {
      ...
      points:
        this.gameService.botDifficulty! === 'EASY'
          ? 500
          : this.gameService.botDifficulty! === 'MEDIUM'
          ? 1000
          : 1500,
    };
  }
